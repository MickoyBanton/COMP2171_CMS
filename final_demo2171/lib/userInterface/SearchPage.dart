...
class ClubSearch extends StatefulWidget {
  ...
  User user;
  ClubSearch({super.key, required this.profileList,required this.user});

  @override
  _ClubSearchState createState() => _ClubSearchState(profileList: profileList,user: user);
}

class _ClubSearchState extends State<ClubSearch> {
  List<dynamic> profileList;
  User user;
  _ClubSearchState({required this.profileList,required this.user});
